...
Iterating actually works. *"Make the headline more concrete."* *"Add a Tom Tunguz-style data point in the intro."* *"Cut the second-to-last paragraph; it's filler."* All valid. You don't have to settle for the first version.
