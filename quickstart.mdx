...
<Note>
📸 **Screenshot — P1.**
The "New Project" creation modal, or the empty-project landing screen, with the project name field visible. Removes the "where do I click?" friction for a non-technical first-time user.
</Note>
...
<Note>
📸 **Screenshot — P1.**
Settings → Connectors showing the gallery of available integrations with logos: Gmail, Calendar, Slack, GitHub, Drive, Notion, Linear, Jira, and others. Lets the reader see scope and recognise their own tools.
</Note>
