...
Open **Customization → Connectors** and click **Connect** on the GitHub card. GitHub's OAuth flow opens.
...
In **Customization → Connectors**, click **Disconnect** on the GitHub card. Tokens are deleted immediately.
