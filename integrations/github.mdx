...
title: GitHub
sidebarTitle: GitHub
description: Connecting Fluso to GitHub. Setup, repository scope, common prompts, and the project-context pattern that makes generated code fit your codebase.
---
...
- **Read/write issues and PRs** — to file issues, open PRs, and leave comments. Always with your approval.
...
<CardGroup cols={2}>
  <Card title="Code feature" icon="code" href="/features/code">
    The full deep dive on what Fluso does inside a codebase.
  </Card>
  <Card title="Bug-to-PR workflow" icon="bug" href="/use-cases/dev-bug-fix">
