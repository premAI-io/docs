...
**The dialog says "DCR rejected."** The server says it supports Dynamic Client Registration but rejected Fluso's request. Switch to the **OAuth (BYO)** tab and register the app manually.
