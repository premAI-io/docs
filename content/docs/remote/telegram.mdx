...
Connector writes in Telegram follow the same effective **Allow**, **Ask**, or **Deny** policy as the app. With **Ask**, the bot shows an approval card and waits for your decision. **Allow** or **Don't ask permission** can continue without a per-action prompt; **Deny** blocks the action.
...
<CardGroup cols={2}>
  <Card title="Apps & MCP" icon="plug" href="/features/mcp">
    What app connections are and how to manage them.
  </Card>
