...
- Read-only tools can run automatically, while write tools follow their effective **Allow**, **Ask**, or **Deny** rule.
...
**Smarter assistant**
- Emails the assistant drafts arrive as properly formatted HTML and sign off with "Sent via fluso.ai", which you can turn off or rename. Gmail sends follow the effective tool and chat approval policy.
