...
<CardGroup cols={2}>
  <Card title="Features" icon="sparkles" href="/features/chat">
    The five primitives: chat, apps, skills, tasks, memory.
  </Card>
  <Card title="Apps & MCP" icon="plug" href="/features/mcp">
    The connection model and the full catalog of supported apps.
  </Card>
  <Card title="Agents (Beta)" icon="bot" href="/developers/agent-builder">
    Build a saved Agent, split work across threads, and schedule follow-ups.
  </Card>
  <Card title="Architecture" icon="network" href="/developers/architecture">
    Request flow, durable data boundaries, and replaceable components.
  </Card>
